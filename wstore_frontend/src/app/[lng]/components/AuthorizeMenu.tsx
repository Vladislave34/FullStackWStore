...
const AuthorizeMenu  : FC<AuthorizeMenuProps> = ({ user}  ) => {
        ...
        <>
            <div ref={menuRef} className="relative">
                ...
                >
                    ...
                    "
                        onClick={() => router.push(`/${currentLang}/profile/my-orders`)}
                    >
                        {t("myorders")}
                    </div>
                    ...
                    "
                        onClick={() => {
                            setOpen(false)
                            router.push(`/${currentLang}/profile/details`)
                        }}
                    >
                        {t('profile')}
                    </div>
